...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyrayt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13742&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyrayt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyrayt` can be installed with:

```
conda install pyrayt
```

It is possible to list all of the versions of `pyrayt` available on your platform with:
